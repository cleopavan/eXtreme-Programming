<?php
	...
	if($library->acessoRecusado('servidor.php', $_SESSION['idNivelServidor']) == FALSE){/* Excessão no caso do servidor não ter acesso a esta área*/
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content">
                ...
                if(isset($_POST["inputCadastraServidor"])){
	             	$library->insereServidor($_POST["inputSiape"], $_POST["inputNome"], 
...
<?php
	if(isset($_POST["btnCadastrarCargo"])){
		if(isset($_POST["inputAuxC"]) && strlen($_POST["inputAuxC"])>0){
			$library->excluiCargo($_POST["inputAuxC"]);
		}
		$confere=$library->insereCargo($_POST["inputNovoCargo"]);
		if($confere==0){
			echo '<div class="tab-pane active" id="inicial">
	...
	if(isset($_POST["btnCadastrarJornada"])){
		if(isset($_POST["inputAuxJ"]) && strlen($_POST["inputAuxJ"])>0){
			$library->excluiJornada($_POST["inputAuxJ"]);
		}
		$resultado=$library->insereJornada($_POST["inputNovaJornada"]);
		if($resultado==0){
			echo '<div class="tab-pane active" id="inicial">
		           <div class="alert alert-danger alert-dismissable">
		              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	...
	if(isset($_POST["btnCadastrarSituacao"])){
		$confere=$library->insereSituacao($_POST["inputNovaSituacao"]);
		if($confere==0){
			echo '<div class="tab-pane active" id="inicial">
		           <div class="alert alert-danger alert-dismissable">
		              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	...
	if(isset($_POST["btnCadastrarNivel"])){
		if(isset($_POST["inputAux"]) && strlen($_POST["inputAux"])>0){
			$library->excluiNivel($_POST["inputAux"]);
		}
		$confere=$library->insereNivel($_POST["inputNovoNivel"]);
		if($confere==0){
			echo '<div class="tab-pane active" id="inicial">
		           <div class="alert alert-danger alert-dismissable">
		              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	...
	if(isset($_POST["btnExcluirNivel"])){
		$library->excluiNivel($_POST["inputComboNivel"]);
		echo '<div class="tab-pane active" id="inicial">
	           <div class="alert alert-success alert-dismissable">
	              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	...
	if(isset($_POST["btnExcluirJornada"])){
		$library->excluiJornada($_POST["inputJornada"]);
		echo '<div class="tab-pane active" id="inicial">
	           <div class="alert alert-success alert-dismissable">
	              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	...
	if(isset($_POST["btnExcluirCargo"])){
		$library->excluiCargo($_POST["inputCargo"]);
		echo '<div class="tab-pane active" id="inicial">
	           <div class="alert alert-success alert-dismissable">
	              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
