<?php
	...
	if($library->acessoRecusado('alocacao.php', $_SESSION['idNivelServidor']) == FALSE){/* Excessão no caso do servidor não ter acesso a esta área*/
    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="breadcrumb">
            ...
            <li><a href="alocacao.php">Alocação</a>
        </ul>
      </div>
    </div>
    <div class="row">
