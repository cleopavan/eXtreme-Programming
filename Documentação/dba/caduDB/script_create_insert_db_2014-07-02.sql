...
CREATE SCHEMA IF NOT EXISTS `u454558226_cadu` DEFAULT CHARACTER SET utf8 ;
USE `u454558226_cadu` ;
...
CREATE TABLE IF NOT EXISTS `u454558226_cadu`.`nivelCurso` (
  `idNivelCurso` INT NOT NULL AUTO_INCREMENT COMMENT 'graduação, especializaç' /* comment truncated */ /*�o,
 mestrado, doutorado.*/,
...
CREATE TABLE IF NOT EXISTS `u454558226_cadu`.`curso` (
  ...
  `idNivelCurso` INT NOT NULL,
  `regValido` TINYINT(1) NOT NULL,
  PRIMARY KEY (`codCurso`),
  INDEX `nivel_idx` (`idNivelCurso` ASC))
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `u454558226_cadu`.`nivelServidor_areaMenu` (
  ...
  PRIMARY KEY (`idAreaMenu`, `idNivelServidor`),
...
START TRANSACTION;
USE `u454558226_cadu`;
INSERT INTO `u454558226_cadu`.`cargo` (`idCargo`, `cargo`, `regValido`) VALUES (0, 'Administrador', 1);
INSERT INTO `u454558226_cadu`.`cargo` (`idCargo`, `cargo`, `regValido`) VALUES (1, 'Docente', 1);
...
START TRANSACTION;
USE `u454558226_cadu`;
INSERT INTO `u454558226_cadu`.`jornada` (`idJornada`, `jornada`, `regValido`) VALUES (0, 'jornada?', 1);
...
INSERT INTO `u454558226_cadu`.`jornada` (`idJornada`, `jornada`, `regValido`) VALUES (3, 'jornada?', 1);
...
START TRANSACTION;
USE `u454558226_cadu`;
INSERT INTO `u454558226_cadu`.`situacaoServidor` (`idSituacaoServidor`, `situacao`, `dataEntrada`, `dataSaida`, `regValido`) VALUES (0, 'ativo', '1900-01-01', NULL, 1);
...
INSERT INTO `u454558226_cadu`.`situacaoServidor` (`idSituacaoServidor`, `situacao`, `dataEntrada`, `dataSaida`, `regValido`) VALUES (3, 'ativo', '2010-01-25', NULL, 1);
...
START TRANSACTION;
USE `u454558226_cadu`;
INSERT INTO `u454558226_cadu`.`servidor` (`siape`, `nome`, `sobrenome`, `observacao`, `quemSubstitui`, `idCargo`, `idJornada`, `idSituacaoServidor`, `email`, `fone1`, `fone2`, `endereco`, `cidade`, `senha`, `idNivelServidor`, `regValido`) VALUES ('1011100117', 'Claunir', 'Pavan', 'Bom professor', '1011100118', 1, 1, 1, 'claunir.pavan@uffs.edu.br', '(49) 8822-1234', 'não info.', 'Av. cidade', 'Chapecó - SC', 'e01f2814dd7fb37b3206ee455cb0444e', 3, 1);
INSERT INTO `u454558226_cadu`.`servidor` (`siape`, `nome`, `sobrenome`, `observacao`, `quemSubstitui`, `idCargo`, `idJornada`, `idSituacaoServidor`, `email`, `fone1`, `fone2`, `endereco`, `cidade`, `senha`, `idNivelServidor`, `regValido`) VALUES ('1011100118', 'Denio', 'Duarte', 'Bom professor', '1011100117', 1, 2, 2, 'denio.duarte@uffs.edu.br', '(49) 9110-1234', 'não info.', 'Av. cidade', 'Chapecó - SC', 'e01f2814dd7fb37b3206ee455cb0444e', 2, 1);
INSERT INTO `u454558226_cadu`.`servidor` (`siape`, `nome`, `sobrenome`, `observacao`, `quemSubstitui`, `idCargo`, `idJornada`, `idSituacaoServidor`, `email`, `fone1`, `fone2`, `endereco`, `cidade`, `senha`, `idNivelServidor`, `regValido`) VALUES ('1011100100', 'Administrador', 'Admin', 'Administrador do sistema', '1011100100', 0, 0, 0, 'administrador@uffs.edu.br', 'não info.', 'não info.', 'não info.', 'não info.', 'e01f2814dd7fb37b3206ee455cb0444e', 0, 1);
INSERT INTO `u454558226_cadu`.`servidor` (`siape`, `nome`, `sobrenome`, `observacao`, `quemSubstitui`, `idCargo`, `idJornada`, `idSituacaoServidor`, `email`, `fone1`, `fone2`, `endereco`, `cidade`, `senha`, `idNivelServidor`, `regValido`) VALUES ('1011100119', 'Rafael', 'Torchelsen', 'Bom professor', '1011100119', 1, 3, 3, 'rafael.torchelsen@uffs.edu.br', '(49) 9922-9222', 'não info.', 'Av. cidade', 'Chapecó - SC', 'e01f2814dd7fb37b3206ee455cb0444e', 1, 1);
...
START TRANSACTION;
USE `u454558226_cadu`;
INSERT INTO `u454558226_cadu`.`nivelCurso` (`idNivelCurso`, `nomeNivelCurso`, `regValido`) VALUES (1, 'Graduação', 1);
INSERT INTO `u454558226_cadu`.`nivelCurso` (`idNivelCurso`, `nomeNivelCurso`, `regValido`) VALUES (2, 'Pós graduação', 1);
...
START TRANSACTION;
USE `u454558226_cadu`;
INSERT INTO `u454558226_cadu`.`curso` (`codCurso`, `nomeCurso`, `idNivelCurso`, `regValido`) VALUES (1001, 'Ciência da computação', 1, 1);
INSERT INTO `u454558226_cadu`.`curso` (`codCurso`, `nomeCurso`, `idNivelCurso`, `regValido`) VALUES (1002, 'Enfermagem', 1, 1);
INSERT INTO `u454558226_cadu`.`curso` (`codCurso`, `nomeCurso`, `idNivelCurso`, `regValido`) VALUES (1003, 'Agronomia', 1, 1);
INSERT INTO `u454558226_cadu`.`curso` (`codCurso`, `nomeCurso`, `idNivelCurso`, `regValido`) VALUES (1004, 'Matemática', 1, 1);
...
INSERT INTO `u454558226_cadu`.`servidorFuncao` (`idFuncao`, `siape`, `dataInicio`, `dataSaida`, `cargaHoraria`, `regValido`) VALUES (1, '1011100119', '2010-01-25', NULL, 40, 1);
...
INSERT INTO `u454558226_cadu`.`areaMenu` (`idAreaMenu`, `nomeAreaMenu`, `descricaoAreaMenu`, `linkAreaMenu`) VALUES (7, '1modelo', '1 Modelo', '1modelo.php');
INSERT INTO `u454558226_cadu`.`areaMenu` (`idAreaMenu`, `nomeAreaMenu`, `descricaoAreaMenu`, `linkAreaMenu`) VALUES (8, '2modelo', '2 Modelo', '2modelo.php');
INSERT INTO `u454558226_cadu`.`areaMenu` (`idAreaMenu`, `nomeAreaMenu`, `descricaoAreaMenu`, `linkAreaMenu`) VALUES (9, 'admArea', 'Administrar áreas', 'admArea.php');
INSERT INTO `u454558226_cadu`.`areaMenu` (`idAreaMenu`, `nomeAreaMenu`, `descricaoAreaMenu`, `linkAreaMenu`) VALUES (10, 'ccr', 'Ccr', 'ccr.php');
INSERT INTO `u454558226_cadu`.`areaMenu` (`idAreaMenu`, `nomeAreaMenu`, `descricaoAreaMenu`, `linkAreaMenu`) VALUES (11, 'alocaCursoCcr', 'Servidor/CursoCcr', 'alocaCursoCcr.php');
...
START TRANSACTION;
USE `u454558226_cadu`;
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (1, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (1, 1, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (1, 2, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (1, 3, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (2, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (2, 1, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (2, 2, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (2, 3, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (3, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (3, 1, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (3, 2, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (3, 3, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (4, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (4, 1, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (4, 2, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (4, 3, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (5, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (5, 1, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (5, 2, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (5, 3, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (6, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (6, 1, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (6, 2, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (6, 3, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (7, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (7, 1, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (7, 2, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (7, 3, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (8, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (8, 1, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (8, 2, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (8, 3, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (9, 0, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (9, 1, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (9, 2, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (9, 3, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (10, 0, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (10, 1, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (10, 2, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (10, 3, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (11, 0, 1);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (11, 1, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (11, 2, 0);
INSERT INTO `u454558226_cadu`.`nivelServidor_areaMenu` (`idAreaMenu`, `idNivelServidor`, `visivel`) VALUES (11, 3, 0);
