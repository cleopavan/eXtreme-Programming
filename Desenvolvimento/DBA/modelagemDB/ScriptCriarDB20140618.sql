...
-- -----------------------------------------------------
-- Table `controleAcademico`.`menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `controleAcademico`.`menu` (
  `idOpcao` INT NOT NULL,
  `nomeOpcao` VARCHAR(45) NULL,
  `linkOpcao` VARCHAR(45) NULL,
  PRIMARY KEY (`idOpcao`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `controleAcademico`.`nivelServidor_has_menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `controleAcademico`.`nivelServidor_has_menu` (
  `idmenu` INT NOT NULL,
  `idNivelServidor` INT NOT NULL,
  PRIMARY KEY (`idmenu`, `idNivelServidor`),
  INDEX `fk_nivelServidor_has_menu_menu1_idx` (`idmenu` ASC),
  INDEX `fk_nivelServidor_has_menu_nivelServidor1_idx` (`idNivelServidor` ASC),
  CONSTRAINT `fk_nivelServidor_has_menu_nivelServidor1`
    FOREIGN KEY (`idNivelServidor`)
    REFERENCES `controleAcademico`.`nivelServidor` (`idNivelServidor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_nivelServidor_has_menu_menu1`
    FOREIGN KEY (`idmenu`)
    REFERENCES `controleAcademico`.`menu` (`idOpcao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `controleAcademico`.`nivelServidor` (
  `idOpcao` INT NOT NULL,
  `idNivelServidor` INT NOT NULL,
  PRIMARY KEY (`idOpcao`, `idNivelServidor`),
  INDEX `fk_nivelServidor_has_menu1_menu1_idx` (`idOpcao` ASC),
